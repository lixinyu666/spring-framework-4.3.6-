...
接下来的章节列出了每个功能可用的模块、它们的工件名字以及它们包含的主题。工件名字与[依赖管理工具](#1.-开始使用spring)中使用的artifact IDs有关。
<a class="link" href="#dependency-management" title="2.3.1&nbsp;Dependency Management and Naming Conventions">Dependency Management tools</a>
